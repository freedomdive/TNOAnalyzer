...
public:
	...
	void ReadFiles(int iIndex, filesystem::path& pPath1, filesystem::path& pPath2, atomic_bool& bBinaryState1, atomic_bool& bBinaryState2, int iThreadNumber);
...
private:
	...
	void WriteResults(Data* pData, int iMinIndex1, int iMinIndex2, const DeltaR& pResultDeltaR, const Rho& pResultRho, const string& sPostfix);
